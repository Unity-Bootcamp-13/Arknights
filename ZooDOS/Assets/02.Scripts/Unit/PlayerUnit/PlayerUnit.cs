...
public class PlayerUnit : Unit
{
    ...
    public void Init(PlayerUnitData playerUnitData)
    {
        ...
        _status = new PlayerUnitStatus(playerUnitData.PlayerUnitType, playerUnitData.StandingIllust, playerUnitData.Name, playerUnitData.Id,  playerUnitData.PlaceCost);
